    ...
    <main>
        <div class="forms-container">
            <form action="">
                ...
                <input type="hidden" name="nombre_autor">
                    ...
                    <div class="bottom_form_right-container">
                        <div class="input_label-container">
                            ...
                            <div class="priceInput-container">
                                ...
                                <input class="input_price" type="number" name="precio_libro" id="precio_libro" min="0" max="1000000">
            ...
            <form class="form_author" action="" method="GET">
